	...
	<center>
		...
		<div class="row movies-list" style="margin:20px;">
			<% 
				...
				PreparedStatement moviequery = dbcon.prepareStatement("SELECT * from movies order by ? limit ? offset ?");
				switch(sort){
					case 2: moviequery.setString(1,"title desc");
					break;
					case 3: moviequery.setString(1,"year");
					break;
					case 4: moviequery.setString(1,"year desc");
					break;
					case 1: moviequery.setString(1,"title");
					break;
					case 5: moviequery.setString(1,"id");
					break;
					case 6: moviequery.setString(1,"id desc");
					break;
					default: moviequery.setString(1,"title");
				}
				//moviequery+=" limit "+disp+" offset "+currPage;
				//ResultSet movieresult = statement1.executeQuery(moviequery);
				currPage=(currPage-1)*disp;
				if(currPage<0) currPage=0;
				moviequery.setInt(2,disp);
				moviequery.setInt(3,currPage);
