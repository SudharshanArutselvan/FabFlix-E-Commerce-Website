...
<body style="background-image:url('./images/bg1.jpg');">
	...
	<div id="logindiv" style="width:340px;margin-left:auto;margin-right:auto;">
		<a id='dashboard' href="/fabflix/" style="font-size:20px;color:#f1a1a1;">Customer Login</a>
		<a id='dashboard' href="/fabflix/employeeLogin" style="font-size:20px;color:#FFF;float:right;">Employee Login</a>
